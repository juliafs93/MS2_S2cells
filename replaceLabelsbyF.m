function[RFP_FTL_tracked_meanF] = replaceLabelsbyF(RFP_FTL_tracked, Stats_GFP_table,minF,maxF,by)
RFP_FTL_tracked_meanF = RFP_FTL_tracked;
for f = 1:size(RFP_FTL_tracked,3)
    toreplace = RFP_FTL_tracked_meanF(:,:,f);
    ...
    RFP_FTL_tracked_meanF(:,:,f) = toreplace;
